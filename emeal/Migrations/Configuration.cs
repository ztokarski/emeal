...
namespace emeal.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<MsqlRecipeDb>
    {
        ...
        protected override void Seed(MsqlRecipeDb context)
        {
            ...
            Product oliwkiZCzosnkiem =
                new Product() {Name = "oliwki nadziewane czosnkiem", PathToImage = "path to image"};
            ...
            Product miesoMieloweWieprzowe =
                new Product() {Name = "mieso mielone wieprzowe", PathToImage = "path to image"};
            ...
            context.Recipes.AddOrUpdate(p => p.Name,
                new Recipe
                {
                    ...
                    Description =
                        "Pomidory po upieczeniu nabierają wyjątkowego aromatu! Spróbuj ich w połączeniu z makaronem i kozim serem!",
                    Author = new User {Name = "Stanislaw", Email = "test@gmail.com", Password = "12345"},
                    ...
                    Steps = new List<Step>
                    {
                        new Step
                        {
                            Name = "PRZYGOTUJ",
                            Order = 1,
                            Description = "blachę piekarnikową i piekarnik rozgrzany do temperatury 200°C"
                        },
                        new Step
                        {
                            Name = "KROK 1: PIECZEMY POMIDORY",
                            Order = 2,
                            Description =
                        ...
                        new Step
                        {
                            ...
                            Order = 3,
                            Description =
                                "Makaron gotujemy zgodnie z instrukcją podaną na opakowaniu. Pomarańczę obieramy, by pozostał sam miąższ, który następnie kroimy na kawałki. Ser kozi osączamy i kruszymy. Kapary osączamy i grubo siekamy. Mieszamy z serem i pomarańczą."
                        },
                        new Step
                        {
                            Name = "KROK 3: ŁĄCZYMY SKŁADNIKI DANIA",
                            Order = 4,
                            Description =
                                "Makaron odcedzamy. Z upieczonych warzyw usuwamy gałązki ziół. Czosnek wyłuskujemy ze skórki, grubo siekamy i dodajemy do mieszanki na bazie sera koziego. Pomidory, cebulę i powstały sok mieszamy z makaronem i rozkładamy na talerzach. Ma wierzch dodajemy kozi ser z dodatkami."
                        },
                    },
            ...
            context.Recipes.AddOrUpdate(p => p.Name,
                new Recipe
                {
                    ...
                    Description =
                        "Bolognese z mnóstwem warzyw, pełnych słońca pomidorów i aromatycznych przypraw. Bez mięsa smakuje równie wyśmienicie.",
                    ...
                    Steps = new List<Step>
                    {
                        new Step
                        {
                            Name = "KROK 1: SMAŻYMY SELER Z CEBULĄ",
                            Order = 1,
                            Description =
                                "Marchew i cebule obieramy, selera oczyszczamy i w razie potrzeby usuwamy włókna. Marchew i selera kroimy w kostkę o wielkości ok. 1 cm, cebulę kroimy w drobną kostkę. Wszystko smażymy na rozgrzanej oliwie przez ok. 5 minut aż do zeszklenia. Rozcieńczamy bulionem i pomidorami, pomidory lekko rozdrabniamy widelcem. Dodajemy czosnek przeciśnięty przez praskę. Doprawiamy solą, pieprzem, szczyptą cukru i oregano. Doprowadzamy do wrzenia."
                        },
                        new Step
                        {
                            Name = "KROK 2: DODAJEMY POMIDORY DO SOSU",
                            Order = 2,
                            Description =
                        ...
                        new Step
                        {
                            Name = "KROK 3: PODAJEMY Z MAKARONEM",
                            Order = 3,
                            Description =
                                "Makaron gotujemy w dużej ilości wrzącej, osolonej wody zgodnie z instrukcją podaną na opakowaniu. Bazylię osuszamy, listki obrywamy i siekamy. Mieszamy z sosem i podajemy z odcedzonym makaronem i startym serem."
                        },
                    },
            ...
            context.Recipes.AddOrUpdate(p => p.Name,
                new Recipe
                {
                    ...
                    Description =
                        "Ostre chili, oliwki nadziewane czosnkiem, ser feta i jogurt naturalny – z tych składników przygotujesz pastę idealną do kanapek.",
                    ...
                    Steps = new List<Step>
                    {
                        ...
                        new Step
                        {
                            Name = "KROK 1: SIEKAMY PAPRYCZKĘ",
                            Order = 2,
                            Description =
                                "Paprykę oczyszczamy, pozbawiamy nasion i kroimy w drobną kostkę. Oliwki osączamy i siekamy wraz z nadzieniem."
                        },
                        new Step
                        {
                            Name = "KROK 2: ŁĄCZYMY SKŁADNIKI PASTY",
                            Order = 3,
                            Description =
                                "Fetę osączamy, kruszymy na małe kawałki i miksujemy wraz z jogurtem na gładką masę. Doprawiamy oregano, pieprzem i odrobiną soli. Dodajemy paprykę i oliwki. Podajemy z chlebem pita."
                        },
                    },
            ...
            context.Recipes.AddOrUpdate(p => p.Name,
                new Recipe
                {
                    ...
                    Description =
                        "Mielony cynamon, kolendra, duża ilość spienionego mleka i oczywiście mocne espresso – z tych składników przygotujesz kawę po portugalsku!",
                    ...
                    Steps = new List<Step>
                    {
                        ...
                        new Step
                        {
                            Name = "KROK 1: UCIERAMY CUKIER",
                            Order = 2,
                            Description =
                                "Cukier ucieramy w moździerzu. Espresso w proszku mieszamy z cynamonem i kolendrą. Zaparzamy ok. 250 ml mocnego espresso z przyprawami."
                        },
                        new Step
                        {
                            Name = "KROK 2: PODGRZEWAMY MLEKO",
                            Order = 3,
                            Description =
                                "Mleko podgrzewamy. Połowę przelewamy do 4 szklanek. Resztę mleka spieniamy i również rozlewamy do szklanek."
                        },
                        new Step
                        {
                            Name = "KROK 3: DEKORUJEMY GALAO",
                            Order = 3,
                            Description =
                                "Espresso ostrożnie dolewamy do mleka, tak aby utworzyło środkową warstwę. Galao posypujemy cukrem i podajemy natychmiast posypane odrobiną cynamonu."
                        },
                    },
            ...
            context.Recipes.AddOrUpdate(p => p.Name,
                new Recipe
                {
                    ...
                    Description =
                        "Tortille z mięsem, awokado, fasolą i ostrym dipem! Zobacz, jak przygotować śniadanie inspirowane kuchnią meksykańską!",
                    ...
                    Steps = new List<Step>
                    {
                        new Step
                        {
                            Name = "KROK 1: PRZYGOTOWUJEMY SOS",
                            Order = 1,
                            Description =
                                "Śmietanę mieszamy z solą, pieprzem cayenne i skórką z limonki, możemy także doprawić miodem. Cebulę oraz czosnek obieramy i kroimy w drobną kostkę. Fasolę odcedzamy, płuczemy i odsączamy."
                        },
                        new Step
                        {
                            Name = "KROK 2: SMAŻYMY MIĘSNY FARSZ",
                            Order = 2,
                            Description =
                                "Kiełbasę grillową nacinamy i wyciskamy mięso z osłonki. Smażymy na gorącej patelni przez ok. 4 minuty, rozdrabniając je. Dodajemy cebulę i czosnek, smażymy razem przez 3 minuty. Dodajemy fasolę i podgrzewamy przez 2-3 minuty, doprawiamy do smaku."
                        },
                        new Step
                        {
                            Name = "KROK 3: ZWIJAMY TORTILLE",
                            Order = 3,
                            Description =
                                "Awokado obieramy, kroimy na pół, pozbawiamy pestki i kroimy w plasterki. Skrapiamy sokiem z limonki. Tortille kolejno podgrzewamy na dużej patelni bez tłuszczu przez 20-30 sekund. Smarujemy śmietaną, układamy awokado i mięsny farsz, zwijamy."
                        },
                    },
            ...
            context.Recipes.AddOrUpdate(p => p.Name,
                new Recipe
                {
                    ...
                    Description =
                        "Krem z rzeżuchy i tostowe paluszki to świetne dodatki do jajek. Wypróbuj koniecznie!",
                    ...
                    Steps = new List<Step>
                    {
                        new Step
                        {
                            Name = "KROK 1: PRZYGOTOWUJEMY KREM Z RZEŻUCHY",
                            Order = 1,
                            Description =
                                "Rzeżuchę obcinamy i mieszamy z serkiem grani i śmietanką, doprawiamy solą, pieprzem i skórką z cytryny."
                        },
                        new Step
                        {
                            Name = "KROK 2: GOTUJEMY JAJKA I SMAŻYMY CHLEB",
                            Order = 2,
                            Description =
                                "Jajka gotujemy na miękko we wrzącej wodzie przez 5-6 minut. W międzyczasie każdą kromkę chleba kroimy na 4 paski i podsmażamy na gorącym maśle ok. 1 minuty z każdej strony."
                        },
                        new Step
                        {
                            Name = "KROK 3: NAKŁADAMY KREM NA JAJKA",
                            Order = 3,
                            Description =
                                "Jajka przelewamy zimną wodą, obieramy ze skorupki i przekładamy po 2 sztuki do szklanki. Lekko nacinamy, doprawiamy solą i pieprzem i rozkładamy na nich krem z rzeżuchy. Dodajemy po 1 łyżeczce kawioru z pstrąga (opcjonalnie). Podajemy z tostowymi paluszkami."
                        },
                    },
            ...
            context.Recipes.AddOrUpdate(p => p.Name,
                new Recipe
                {
                    ...
                    Description =
                        "Marchewka, imbir i pomarańcza to doskonała kompozycja na zimowe dni. Wypróbuj i zaserwuj swoim domownikom.",
                    Author = jnowak,
                    Ingredients = new List<Ingredient>
                    {
                        ...
                        new Ingredient
                        {
                            ...
                            Amount = 6,
                            UnitType = Unit.szt,
                            Description = "malinowa lub soczysta, ok. 150g"
                        },
                    ...
                    Steps = new List<Step>
                    {
                        ...
                        new Step
                        {
                            Name = "KROK 2: WYCISKAMY SOK Z MARCHEWKI I IMBIRU",
                            Order = 2,
                            Description =
                                "Marchewki i korzeń imbiru obieramy i grubo siekamy. Sok wyciskamy w sokowirówce."
                        },
                        new Step
                        {
                            Name = "KROK 3: WYCISKAMY SOK Z POMARAŃCZY",
                            Order = 3,
                            Description =
                                "1 pomarańczę kroimy na pół i odcinamy kilka cienkich plastrów (do dekoracji). Wszystkie pomarańcze wyciskamy."
                        },
                        new Step
                        {
                            Name = "KROK 4: MIESZAMY SOKI",
                            Order = 4,
                            Description =
                                "Sok z pomarańczy oraz sok z marchwi i imbiru mieszamy z olejem i przelewamy do szklanek. Dekorujemy plasterkami pomarańczy i od razu podajemy ze słomkami."
                        }
                    },
            ...
            context.Recipes.AddOrUpdate(p => p.Name,
                new Recipe
                {
                    ...
                    Description =
                        "Spróbuj dorsza z orzeźwiającym aromatem pomarańczy. Podany na podsmażonej kapuście z kremem balsamicznym.",
                    Author = jnowak,
                    Ingredients = new List<Ingredient>
                    {
                        new Ingredient
                        {
                            ...
                            Amount = 4,
                            UnitType = Unit.szt,
                            Description = "mrożone filety"
                        },
                        new Ingredient
                        {
                            Product = kapustaBiala,
                            Amount = 1,
                            UnitType = Unit.kg,
                            Description = "najlepiej o stożkowatym kształcie"
                        },
                        ...
                        new Ingredient
                        {
                            ...
                            Amount = 1,
                            UnitType = Unit.łyż,
                            Description = "najlepiej spadziowy"
                        },
                    ...
                    Steps = new List<Step>
                    {
                        new Step
                        {
                            Name = "KROK 1: PODSMAŻAMY KAPUSTĘ",
                            Order = 1,
                            Description =
                        ...
                        new Step
                        {
                            Name = "KROK 2: SMAŻYMY FILETY Z DORSZA",
                            Order = 2,
                            Description =
                                "Filety z dorsza myjemy i osuszamy. Doprawiamy sokiem wyciśniętym z pomarańczy, solą i pieprzem. Smażymy na gorącym maśle z każdej strony przez 2-3 minuty. Kapustę doprawiamy do smaku i podajemy z rybą."
                        },
                    },
